...
bootloader = ROOT / "build-synclock/bootloader/bootloader.bin"
ptable = ROOT / "build-synclock/partition_table/partition-table.bin"
app = ROOT / "build-synclock/c5vrx2_realtime_iq.bin"
...
def find_esp_port():
    ...
    for p in ports:
        # Check for Espressif VID 0x303A or description/hwid
...
print("=== Ready to flash Golden Phase5 with Sync-Lock S-Curve ===")
print("Waiting for ESP32-C5 to connect (Hold B, tap R on XIAO if needed)...")
