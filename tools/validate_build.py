...
check("four .bsasm programs (Golden + output experiment + Trajectory v2 + LIFT-FM oracle)",
      {f.name for f in bsasm_files} == {"fm.bsasm", "fm4.bsasm", "fm_traj.bsasm", "fm_lift16_phase.bsasm"},
