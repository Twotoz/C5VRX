...
bootloader = ROOT / "build-100ns/bootloader/bootloader.bin"
ptable = ROOT / "build-100ns/partition_table/partition-table.bin"
app = ROOT / "build-100ns/c5vrx2_realtime_iq.bin"
...
print("=== Ready to flash 100ns Discriminator Build ===")
