...
bootloader = ROOT / "build-parlio4-live/bootloader/bootloader.bin"
ptable = ROOT / "build-parlio4-live/partition_table/partition-table.bin"
app = ROOT / "build-parlio4-live/c5vrx2_realtime_iq.bin"
...
print("Ready to flash 4-bit @ 80 MHz Live build.")
print("Waiting for ESP32-C5 on COM10 (Hold B, tap R on XIAO)...")

for attempt in range(1, 60):
    res = subprocess.run(cmd)
    if res.returncode == 0:
        print("\n*** FLASH 4-BIT @ 80 MHz LIVE SUCCEEDED! ***")
        sys.exit(0)
